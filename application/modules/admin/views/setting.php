    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><a class="btn btn-primary" href="<?php echo base_url('admin/message_list')?>"><i class="fa fa-th-list">&nbsp;Setting list</i></a> </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('admin/setting') ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">English Site Title * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Hindi Site Title * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">English Meta Tags * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Hindi Meta Tags * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">English CopyRight * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Hindi CopyRight * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">English Contact Us * </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Hindi  Contact Us * </label>
                                        <div class="col-md-9">
