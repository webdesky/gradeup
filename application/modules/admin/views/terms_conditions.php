    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><a class="btn btn-primary" href="<?php echo base_url('admin/message_list')?>"><i class="fa fa-th-list">&nbsp;Terms And Conditions</i></a> </div>
                            ...
                            <form role="form" method="post" action="<?php echo base_url('admin/terms') ?>" class="registration_form1" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 border-rights">
                                    <div class="form-group">
                                        <label class="col-md-3">English T&C* </label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6 border-rights">
                                    <div class="form-group">
                                        <label class="col-md-3">Hindi T&C * </label>
                                        <div class="col-md-9">
