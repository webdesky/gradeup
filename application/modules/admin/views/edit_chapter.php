    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo base_url('admin/notices_list')?>"><i class="fa fa-th-list">&nbsp;Add Chapter</i></a> </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" value="1"  <?php if($chapter[0]->is_active=="1"){?> checked<?php }?>>Active
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" value="0" <?php if($chapter[0]->is_active=="0"){?> checked<?php }?>>Inactive
                                        </label>
                                    </div>
                                </div>
