                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <form role="form" method="post" action="<?php if(isset($exam)){ echo base_url('admin/package/'.$exam[0]->id); }else{ echo base_url('admin/package'); }?>" class="registration_form1" enctype="multipart/form-data">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-3">Package Name * </label>
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" name="exam_name" id="exam_name" placeholder="Package Name" autocomplete="off" required="required" value="<?php if(isset($exam)){ echo $exam[0]->package_name; }else{echo set_value('package_name');} ?>"> <span class="red"><?php echo form_error('exam_name'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
