                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('admin/addRights') ?>" class="registration_form1" enctype="multipart/form-data">
                                ...
                                <?php
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            <?php echo ucfirst($menu->menu_name);?> </label>
                                        <div class="col-lg-6 col-md-6">
                                            <input type="hidden" name="user_role[]" value="<?php echo $menu->menu_name;?>">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="<?php echo $menu->menu_name;?>_add" value="1" <?php if(isset($right) && $right[0]==1){ echo 'checked';}?> class="form-control"><span class="glyphicon glyphicon-plus"></span>
                                            </label>
                                            <label class="checkbox-inline">
