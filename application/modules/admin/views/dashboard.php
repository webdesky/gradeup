		...
		<div class="widget">
			...
			<div class="widget-content">
				<div class="shortcuts">
					...
					<a href="<?php echo base_url('admin/packageList');?>" class="shortcut"> 
					  	<i class="shortcut-icon fa fa-cog"></i>
					  	<span class="shortcut-label">Package</span> 
					</a>
				</div>
				<!-- /shortcuts -->
			</div>
