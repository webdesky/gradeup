                            ...
                            <form role="form" method="post" action="<?php if(isset($menu)){ echo base_url('admin/menu/'.$menu[0]->id); }else{ echo base_url('admin/menu'); }?>" class="registration_form1" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="url" id="url" placeholder="url" autocomplete="off" required="required" value="<?php if(isset($menu) && !empty($menu[0]->url)){ echo $menu[0]->url; }else{echo set_value('url');} ?>"> <span class="red"><?php echo form_error('url'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="meta_title" id="meta_title" placeholder="Meta Title" autocomplete="off" required="required" value="<?php if(isset($menu) && !empty($menu[0]->meta_title)){ echo $menu[0]->meta_title; }else{echo set_value('meta_title');} ?>"> <span class="red"><?php echo form_error('meta_title'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="8" id="meta_description" name="meta_description" placeholder="Meta Description">
                                                <?php if(isset($menu) && !empty($menu[0]->meta_description)){ echo $menu[0]->meta_description; }else{echo set_value('meta_description');} ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="8" id="meta_keyword" name="meta_keyword" placeholder="Meta Keyword">
                                               <?php if(isset($menu) && !empty($menu[0]->meta_keyword)){ echo $menu[0]->meta_keyword; }else{echo set_value('meta_keyword');} ?>
