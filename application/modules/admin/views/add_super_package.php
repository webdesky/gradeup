<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php if(isset($super_package) && !empty($super_package)){ echo 'Edit Super Package';}else{ echo 'Add Super Package';}?></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo base_url('admin/super_packageList')?>"><i class="fa fa-th-list">&nbsp;Package List</i></a> </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(isset($super_package)){ echo base_url('admin/super_package/'.$super_package[0]->id); }else{ echo base_url('admin/super_package'); }?>" class="registration_form1" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Valid Till * </label>
                                        <div class="col-lg-9">
                                            <input type="text" id="valid_till" name="valid_till" class="form-control date" autocomplete="off" readonly="readonly" required="required" value="<?php if(isset($super_package)){ echo $super_package[0]->valid_till; }else{echo set_value('super_package_name');} ?>"> <span class="red"><?php echo form_error('valid_till'); ?></span> </div>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3">Package Price * </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="package_price" id="package_price" placeholder=" Package Price" autocomplete="off" required="required" value="<?php if(isset($super_package)){ echo $super_package[0]->package_price ; }else{echo set_value('super_package_name');} ?>"> <span class="red"><?php echo form_error('package_price'); ?></span>
                                        </div>
                                    </div>
                                </div>
